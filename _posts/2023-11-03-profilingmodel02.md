...
> $C_i= ln[ 1/Π(U_i / L_i) * L_i]$<br><br>
> $U_i$ : 표현 $t_i$ 가 포함하는 고유한 철자 또는 기호의 종류 수<br><br>
> $L_i$ : 표현 $t_i$ 의 길이(철자 및 기호 개수)<br><br>
> <br><br>
...
> $t_i$ : 문서 내 i번 째 표현<br>
> $s_{male}$ : 작성자의 성별이 남성(m)인 문장<br>
> $s_{female}$ : 작성자의 성별이 여성(f)인 문장<br>
> <br><br>
...
> $t_i$ : 문서 내 i번 째 표현<br>
> $s_{age}$ : 작성자의 연령대가 age인 문장<br>
> $s_{other}$ : 작성자의 연령대가 age가 아닌 문장<br>
> <br><br>
